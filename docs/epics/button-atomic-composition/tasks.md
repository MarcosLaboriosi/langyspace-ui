...
- [x] [T01 — congelar inventário e cobertura](tasks/01-inventory-and-coverage.md)
- [x] [T02 — criar o atom Spinner](tasks/02-spinner-atom.md)
- [x] [T03 — migrar spinners dos produtos](tasks/03-spinner-adoption.md)
- [x] [T04 — criar ActionLink e recipe compartilhado](tasks/04-action-link.md)
- [x] [T05 — migrar links de ação comprovados](tasks/05-action-link-adoption.md)
