...
- [x] [T03 — Contratos e package candidato](tasks/03-package-candidate.md)
- [x] [T04 — Adoção Admin](tasks/04-admin-adoption.md)
- [x] [T05 — Adoção Teacher](tasks/05-teacher-adoption.md)
- [x] [T06 — Cleanup Student e revisão final](tasks/06-student-cleanup-final-review.md)
- [x] [T07 — Release, produção e encerramento](tasks/07-release-production.md)
